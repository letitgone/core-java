...
public class ScriptTest {
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                ...
                final String frameClassName = args.length < 2 ? "section_01.script.buttons1.ButtonFrame" : args[1];
    ...
    private static void addListener(String beanName, String eventName, final String scriptCode,
        ...
        if (descriptor == null)
            return;
        descriptor.getAddListenerMethod().invoke(bean, Proxy
            .newProxyInstance(null, new Class[] {descriptor.getListenerType()},
                (proxy, method, args) -> {
